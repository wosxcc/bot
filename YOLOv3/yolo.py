...
class YOLO(object):
    def __init__(self):
        self.model_path = 'model_data/xccface.h5' # model path or trained weights path
        self.anchors_path = 'model_data/face_anchors.txt'
        ...
        self.model_image_size = (192, 192) # fixed size or (None, None), hw
...
def detect_video(yolo, video_path="", output_path=""):
    ...
    while True:
        ...
        # cv2.resize(result,imgsize,interpolation=cv2.INTER_CUBIC)
