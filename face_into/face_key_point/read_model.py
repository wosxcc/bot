...
def recognize(jpg_path, pb_file_path,img_w,img_h):
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            sess.run(init)
            input_x = sess.graph.get_tensor_by_name("batch:0")
            print (input_x)
            out_softmax = sess.graph.get_tensor_by_name("softmax_linear/softmax_linear:0")
            print (out_softmax)
...
recognize("E:/xbot/face_into/face68/image_test", "./face_key/face_ID/face.pb",160,160)  ##../face68/image_test   E:/face72/trainb    E:/xbot/face_into/face68/image_test
